<?php
class Internal_model extends MY_Model {
    ...
    public function __construct() {
     ...
     public function getGridData() {
        $query = "  SELECT  a.*,
                    ...
                    WHERE a.calibration_type='Internal' AND a.statusdata='active' ORDER BY startcalibration_date DESC ";
    ...
    function getGridDatadetail($idheader) {
     ...
     function GridData_kalibrasi($id) {
        $query = " SELECT 
                 ...
                 LEFT JOIN $this->table_vendor c on a.$this->prefix_id_vendor = c.$this->prefix_id_vendor                 
                 WHERE 
                 a.$this->prefix_id='$id' AND a.statusdata='active' ORDER BY a.status_calibration ASC ";
        return $this->db->query($query);
    }
