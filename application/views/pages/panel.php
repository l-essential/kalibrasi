<a href="javascript:;" data-click="theme-panel-expand" class="theme-collapse-btn"><i class="ion-ios-cog-outline"></i></a>
      <div class="theme-panel-content">
       <h5 class="m-t-0" style="text-align: center;">Setting Theme </h5>
