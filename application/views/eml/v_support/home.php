<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"><i class="fas fa-map-marker-alt"></i> <?php echo $title; ?></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
<script type="text/javascript">
    ...
    datacolumn = [
         {"data": "message_name", "width": "10px", "sClass": "text-center",
            "bSortable": false,
            "mRender": function (data, type, row) {
                var btn = "";
                    btn = btn + "<td class='mailbox-name'><a href='#'>"+ row.message_name + "</a></td>"
                return btn;
            }
        },
        ...
        {"data": "id_satuan", "width": "10px", "sClass": "text-center",
            ...
            "mRender": function (data, type, row) {
                var btn = "";
                    btn = btn + "<td class='mailbox-subject'><b>" + row.message_subject + "</b> - " + row.message + "</td>"
                    
                return btn;
            }
        },
        {"data": "message_divisi", "width": "10px", "sClass": "text-center",
            "bSortable": false,
            "mRender": function (data, type, row) {
                var btn = "";
                    btn = btn + "<td class='mailbox-date'>" +  row.message_divisi + "</td>"
