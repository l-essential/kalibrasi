        ...
        <div class="card-body">
            <div class="row">
                <div class="col-xs-6 col-lg-4">
                    <div class="card card-outline-success">
                        <div class="card-header">
                            <span style="color: white"><strong>Menu Preview</strong></span>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-xs-12 col-sm-6 col-lg-8">
                    <div class="table-responsive">
                        ...
                        <table id="dataintablemenu" class="table table-bordered color-table muted-table" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center" width="80px">Order</th>    
