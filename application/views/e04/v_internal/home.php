<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"><i class="fas fa-tools"></i> <?php echo $title; ?></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        {"data": "id_satuan", "width": "100px", "sClass": "text-center",
            ...
            "mRender": function (data, type, row) {
                ...
                var idtr = row["<?php echo $prefix_id; ?>"];
                    ...
                    btn = btn + "<a href='javascript:void(0)'  class='text-inverse' title='' data-toggle='tooltip' data-original-title='Edit' style='color:#20c997'>"+ row.startcalibration_date +" <i class='fas fa-calendar-check'></i></a> &nbsp;";
