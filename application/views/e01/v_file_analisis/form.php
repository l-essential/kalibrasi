                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-9 col-lg-12">
                            <textarea id="areaeditor" name="keterangan" cols="18" rows="3" <?php echo (isset($default['readonly_keterangan'])) ? $default['readonly_keterangan'] : ''; ?> ><?php echo (isset($default['keterangan'])) ? $default['keterangan'] : ''; ?></textarea>
                        </div>                        
                    </div>    
                </div>
