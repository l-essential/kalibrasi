<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"><i class="far fa-images"></i> <?php echo $title; ?></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
<script type="text/javascript">
    ...
    datacolumn = [
        ...
        {
        "data": "nama_gambar", "width": "10px", "sClass": "text-center",
        "bSortable": false,
        "mRender": function (data, type, row) {
            var btn = "";
           
                btn = btn + "<a href='<?php echo base_url(); ?> "+ row.nama_gambar +"' class='text-inverse' title='' data-toggle='tooltip' data-original-title='Edit'>"+ row.nama_gambar +"</a>";
            return btn;
        }
        },
        // {"data": "nama_gambar",},
