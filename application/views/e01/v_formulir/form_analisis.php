                ...
                <div class="table-responsive" style="padding-left: 17px;padding-right: 17px;">
                  <table class="table table-bordered" width="100%">
                    ...
                    <tr>
                      ...
                      <th class="text-center">Kepala Department Pelapor</th>
                      <th class="text-center">Di Evaluasi Oleh</th>
                    </tr>
                    <tr>
                    ...
                    <tbody style="font-family: initial;font-size: 14px;">
                        <tr>
                          <td class="text-center" style="height: 70px;width: 170px;">
                            <?php echo $preview->namaKaryawan ?><br>
                            <?php echo $preview->time ?>
                          </td>
                          <td class="text-center" style="height: 70px;width: 170px;">
                            <?php echo $preview->approveby ?><br>
                            <?php echo $preview->time_a ?>
                          </td>
                          <td class="text-center" style="height: 70px;width: 170px;">
                            <?php echo $preview->approveby ?><br>
                            <?php echo $preview->time_a ?>
