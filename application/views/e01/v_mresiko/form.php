        ...
        <form id="formdata" data-parsley-validate="" novalidate="">
            ...
            <input type="hidden" name="<?php echo $prefix_id ?>" id="id" value="<?php echo $id; ?>" />
             <input type="hidden" name="actiondata" id="actiondata" />
                ...
                <input type="hidden" name="checkdata1" id="checkdata1" value="kode_resiko" />
            ...
            <div class="form-group">
              <label for="type" >Kode Katagori</label>
                <input name="kode_resiko" id="kode_resiko" type="text" required="" parsley-type="text" placeholder="Fill kode_resiko" class="form-control"
                        value="<?php echo (isset($default['kode_resiko'])) ? $default['kode_resiko'] : ''; ?>"
                        <?php echo (isset($default['readonly_kode_resiko'])) ? $default['readonly_kode_resiko'] : ''; ?>
                        >
            </div>
            <div class="form-group">
                <label for="type" >Nama Katagori</label>
                  <input name="nama_resiko" id="nama_resiko" type="text" required="" parsley-type="text" placeholder="Fill nama_resiko" class="form-control"
                          value="<?php echo (isset($default['nama_resiko'])) ? $default['nama_resiko'] : ''; ?>"
                          <?php echo (isset($default['readonly_nama_resiko'])) ? $default['readonly_nama_resiko'] : ''; ?>
                          >
            </div>
