  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"><i class="fas fa-clipboard-list"></i> <?php echo $title ?></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
$(document).ready(function () {
        ...
        $("#dataintable").dataTable({
            ...
            "mRender": function (data, type, row) {
                ...
                if (accessedit == true) {
                    btn = btn + "<a href='javascript:void(0)' onClick='editdata(" + idtr + ")'><i class='fas fa-file-signature'></i></a>&nbsp;&nbsp;&nbsp;";
                }
         ...
         
         {
            ...
            "mRender": function (data, type, row) {
                ...
                if (row.status_approve == '0') {
                    ...
                    status = "<button class='btn btn-block btn-like btn-xs'>Approve</button>";
                }
                return status;
            }
        },
