 ...
 <section class="content">
      <div class="row">
        ...
        <form id="formdata" class="form-horizontal" data-parsley-validate="" novalidate="">
            ...
            <input type="hidden" name="checkdata1" id="checkdata1" value="info_tutorial_title" />
            ...
            <div class="form-group row">
                <label for="info_tutorial_title" class="col-sm-2 text-right control-label col-form-label">Tutorial Title <span style="color:red">*</span></label>
                <div class="col-sm-10">
            ...
            <div class="form-group row">
                <label for="info_tutorial_note" class="col-sm-2 text-right control-label col-form-label">Tutorial Note <span style="color:red">*</span></label>
                <div class="col-sm-10">
                   <textarea name="info_tutorial_note" class="form-control" rows="3"
                        <?php echo (isset($default['readonly_info_tutorial_note'])) ? $default['readonly_info_tutorial_note'] : ''; ?> ><?php echo (isset($default['info_tutorial_note'])) ? $default['info_tutorial_note'] : ''; ?></textarea>
                </div>                        
            </div> 
            <div class="col-sm-12">
              <p class="text-right">
