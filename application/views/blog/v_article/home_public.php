...
<script type="text/javascript">
    url_setstatuspublic = '<?php echo $url_setstatuspublic; ?>';
            ...
            "columns": [
                            ...
                            {"data": "status_article", "sClass": "text-center",
                              "mRender": function (data, type, row) {
                                    var btn = "";
                                        btn = btn + "<i class='far fa-thumbs-up' style='color:#20c997'></i>";
                                    return btn;
                                }
                            },
    ...
    function setstatuspublic(status, id) {
        $.ajax({
            url: url_setstatuspublic,
            type: "post",
            dataType: "json",
            cache: false,
            data: {
