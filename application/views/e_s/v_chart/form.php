...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        if (actiondata == 'update') {
            var getdata = postaction('<?php echo $url_getdata; ?>', {'tools_code': $("#tools_code").val()});
            homedetail(getdata);
        }
        ...
        $("#formdata").on('submit', function (e) {
            ...
            if (form.parsley().isValid()) {
                ...
                if (resultdata.valid == true && actiondata == 'create') {
                    var getdata = postaction('<?php echo $url_getdata; ?>', {'tools_code': resultdata.postdata.tools_code});
                    homedetail(getdata);
