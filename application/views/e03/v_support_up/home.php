<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"><i class="fas fa-link"></i> <?php echo $title; ?></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    datacolumn = [
            {
                ...
                "mRender": function (data, type, row) {
                    ...
                    var idtr = row["<?php echo $prefix_id; ?>"];
                        ...
                        btn = btn + "<a href='"+ row.url_apps +"' class='text-inverse' target='_blank'title='' data-toggle='tooltip' data-original-title='Edit'><i class='far fa-paper-plane'></i></a> &nbsp;";
