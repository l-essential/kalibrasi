    ...
    <section class="content">
      <div class="row">
        <div class="col-12">
            ...
            <input type="hidden" name="konsep_produk_baru_id" id="konsep_produk_baru_id" value="<?php echo $konsep_produk_baru_id; ?>" />
                ...
                <div class="col-sm-12 invoice-col">
                  <!-- <div class="form-group row">
                        ...
                        <div class="col-9 col-sm-10">
                            <input name="no_konsep_produk" minlength="1" maxlength="50" id="no_konsep_produk" type="text" parsley-type="text" placeholder="input no_konsep_produk" class="form-control"
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-9 col-sm-10">
                            <input name="tanggal_pembuatan" minlength="1" maxlength="50" id="tanggal_pembuatan" type="text"  parsley-type="text" placeholder="input tanggal pembuatan" class="form-control"
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-9 col-sm-10">
                            <input name="nama_merk" minlength="1" maxlength="50" id="nama_merk" type="text"  parsley-type="text" placeholder="input nama merk" class="form-control"
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-9 col-sm-10">
                            <input name="nama_produk" minlength="1" maxlength="50" id="nama_produk" type="text"  parsley-type="text" placeholder="input nama produk" class="form-control"
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-9 col-sm-10">
                            <input name="deskripsi_produk" minlength="1" maxlength="50" id="deskripsi_produk" type="text"  parsley-type="text" placeholder="input deskripsi produk" class="form-control"
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-9 col-sm-10">
                            <input name="kbahan_aktif" minlength="1" maxlength="50" id="kbahan_aktif" type="text"  parsley-type="text" placeholder="input kandungan banhan aktif" class="form-control"
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-9 col-sm-10">
                            <input name="kegunaan" minlength="1" maxlength="50" id="kegunaan" type="text"  parsley-type="text" placeholder="input ukuran kemasan" class="form-control"
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-9 col-sm-10">
                            <input name="cara_pemakaian" minlength="1" maxlength="50" id="cara_pemakaian" type="text"  parsley-type="text" placeholder="input cara_pemakaian" class="form-control"
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-9 col-sm-10">
                            <input name="warna" minlength="1" maxlength="50" id="warna" type="text"  parsley-type="text" placeholder="input warna" class="form-control"
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-9 col-sm-10">
                            <input name="bentuk" minlength="1" maxlength="50" id="bentuk" type="text"  parsley-type="text" placeholder="input bentuk" class="form-control"
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-9 col-sm-10">
                            <input name="aroma" minlength="1" maxlength="50" id="aroma" type="text"  parsley-type="text" placeholder="input aroma" class="form-control"
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-9 col-sm-10">
                            <input name="pH" minlength="1" maxlength="50" id="pH" type="text"  parsley-type="text" placeholder="input ph" class="form-control"
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-9 col-sm-10">
                            <input name="viskositas" minlength="1" maxlength="50" id="viskositas" type="text"  parsley-type="text" placeholder="input viskositas" class="form-control"
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-9 col-sm-10">
                            <input name="berat_jenis" minlength="1" maxlength="50" id="berat_jenis" type="text"  parsley-type="text" placeholder="input berat jenis" class="form-control"
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-9 col-sm-10">
                            <input name="produk_acuan" minlength="1" maxlength="50" id="produk_acuan" type="text"  parsley-type="text" placeholder="input produk acuan" class="form-control"
                ...
                <div class="form-group row">
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-9 col-sm-10">
                              ...
                              <input name="primer_jenis_lainlain" minlength="1" maxlength="50" id="useraccess" type="text" parsley-type="text" placeholder="input lain lain" class="form-control"
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-9 col-sm-10">
                            <input name="primer_bahan_kemasan" minlength="1" maxlength="50" id="primer_bahan_kemasan" type="text"  parsley-type="text" placeholder="input bahan kemasan" class="form-control"
                  ...
                  <div class="form-group row">
                        ...
                        <input type="radio" name="primer_warna_kemasan" id="primer_warna_kemasan" value="Transparant" <?php echo ($default['primer_warna_kemasan']=='Transparant' ? 'checked' : '');?>>
                              ...
                              <input name="primer_warna_lainlain" minlength="1" maxlength="50" id="warna_kemasan" type="text" parsley-type="text" placeholder="input lain lain" class="form-control"
                  ...
                  <!-- <div class="form-group row">
                        ...
                        <div class="col-9 col-sm-10">
                            <input name="primer_uji_kebocoran" minlength="1" maxlength="50" id="primer_uji_kebocoran" type="text"  parsley-type="text" placeholder="input primer_uji_transportasi sediaan" class="form-control"
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-9 col-sm-10">
                            <input name="primer_tinggi_kemasan" minlength="1" maxlength="50" id="primer_tinggi_kemasan" type="text"  parsley-type="text" placeholder="input tinggi kemasan" class="form-control"
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-9 col-sm-10">
                            <input name="primer_diameter_dalam" minlength="1" maxlength="50" id="primer_diameter_dalam" type="text"  parsley-type="text" placeholder="input diameter dalam" class="form-control"
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-9 col-sm-10">
                            <input name="primer_diameter_luar" minlength="1" maxlength="50" id="primer_diameter_luar" type="text"  parsley-type="text" placeholder="input diameter luar" class="form-control"
                  ...
                  <div class="form-group row">
                        <label for="primer_kapasitas_kemasan" class="col-3 col-sm-2 col-form-label text-left">g. Kapasitas Kemas <span style="color:red">*</span></label>
                        <div class="col-9 col-sm-10">
                            <input name="primer_kapasitas_kemasan" minlength="1" maxlength="50" id="primer_kapasitas_kemasan" type="text"  parsley-type="text" placeholder="input kapasita kemasan" class="form-control"
                                   value="<?php echo (isset($default['primer_kapasitas_kemasan'])) ? $default['primer_kapasitas_kemasan'] : ''; ?>"
                                   <?php echo (isset($default['readonly_primer_kapasitas_kemasan'])) ? $default['readonly_primer_kapasitas_kemasan'] : ''; ?>
                                   >
                        </div>                        
                  </div>  
                  <div class="form-group row">
                        <label for="primer_valume_kemasan" class="col-3 col-sm-2 col-form-label text-left">h. Volume Kemasan <span style="color:red">*</span></label>
                        <div class="col-9 col-sm-10">
                            <input name="primer_valume_kemasan" minlength="1" maxlength="50" id="primer_valume_kemasan" type="text"  parsley-type="text" placeholder="input valume kemasan" class="form-control"
                                   value="<?php echo (isset($default['primer_valume_kemasan'])) ? $default['primer_valume_kemasan'] : ''; ?>"
                                   <?php echo (isset($default['readonly_primer_valume_kemasan'])) ? $default['readonly_primer_valume_kemasan'] : ''; ?>
                                   >
                        </div>                        
                  </div>
                  <div class="form-group row">
                        ...
                        <div class="col-9 col-sm-10">
                            <input name="primer_uji_kebocoran" minlength="1" maxlength="50" id="primer_uji_kebocoran" type="text"  parsley-type="text" placeholder="input uji kebocoran" class="form-control"
                                   value="<?php echo (isset($default['primer_uji_kebocoran'])) ? $default['primer_uji_kebocoran'] : ''; ?>"
                                   <?php echo (isset($default['readonly_primer_uji_kebocoran'])) ? $default['readonly_primer_uji_kebocoran'] : ''; ?>
                                   >
                        </div>                        
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-9 col-sm-10">
                            <input name="primer_uji_transportasi" minlength="1" maxlength="50" id="primer_uji_transportasi" type="text"  parsley-type="text" placeholder="input uji trasportasi" class="form-control"
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-9 col-sm-10">
                              ...
                              <input name="primer_warna_lainlain" minlength="1" maxlength="50" id="sekunderjeniskemasan" type="text" parsley-type="text" placeholder="input lain lain" class="form-control"
                                   value="<?php echo (isset($default['primer_warna_lainlain'])) ? $default['primer_warna_lainlain'] : ''; ?>"
                                   <?php echo (isset($default['readonly_primer_warna_lainlain'])) ? $default['readonly_primer_warna_lainlain'] : ''; ?>
                                   >
                        </div>                        
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-9 col-sm-10">
                            <input name="sekunder_bahan_kemasan" minlength="1" maxlength="50" id="sekunder_bahan_kemasan" type="text"  parsley-type="text" placeholder="input bahan kemasan" class="form-control"
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-9 col-sm-10">
                            <input name="sekunder_warna_kemasan" minlength="1" maxlength="50" id="sekunder_warna_kemasan" type="text"  parsley-type="text" placeholder="input warna kemasan" class="form-control"
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-9 col-sm-10">
                            <input name="sekunder_panjang_kemasan" minlength="1" maxlength="50" id="sekunder_panjang_kemasan" type="text"  parsley-type="text" placeholder="input panjang kemasan" class="form-control"
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-9 col-sm-10">
                            <input name="sekunder_lebar_kemasan" minlength="1" maxlength="50" id="sekunder_lebar_kemasan" type="text"  parsley-type="text" placeholder="input lebar kemasan" class="form-control"
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-9 col-sm-10">
                            <input name="sekunder_tinggi_kemasan" minlength="1" maxlength="50" id="sekunder_tinggi_kemasan" type="text"  parsley-type="text" placeholder="input tinggi kemasan" class="form-control"
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-9 col-sm-10">
                            <input name="sekunder_tebal_kemasan" minlength="1" maxlength="50" id="sekunder_tebal_kemasan" type="text"  parsley-type="text" placeholder="input tebal kemasan" class="form-control"
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-9 col-sm-10">
                              ...
                              <input name="tersier_warna_lainlain" minlength="1" maxlength="50" id="tersierjeniskemasan" type="text" parsley-type="text" placeholder="input lain lain" class="form-control"
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-9 col-sm-10">
                            <input name="tersier_bahan_kemasan" minlength="1" maxlength="50" id="tersier_bahan_kemasan" type="text"  parsley-type="text" placeholder="input bahan Kemasan" class="form-control"
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-9 col-sm-10">
                            <input name="tersier_warna_kemasan" minlength="1" maxlength="50" id="tersier_warna_kemasan" type="text"  parsley-type="text" placeholder="input warna kemasan" class="form-control"
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-9 col-sm-10">
                            <input name="tersier_panjang_kemasan" minlength="1" maxlength="50" id="tersier_panjang_kemasan" type="text"  parsley-type="text" placeholder="input panjang kemasan" class="form-control"
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-9 col-sm-10">
                            <input name="tersier_lebar_kemasan" minlength="1" maxlength="50" id="tersier_lebar_kemasan" type="text"  parsley-type="text" placeholder="input lebar kemasan" class="form-control"
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-9 col-sm-10">
                            <input name="tersier_tinggi_kemasan" minlength="1" maxlength="50" id="tersier_tinggi_kemasan" type="text"  parsley-type="text" placeholder="input tinggi kemasan" class="form-control"
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-9 col-sm-10">
                            <input name="tersier_tebal_kemasan" minlength="1" maxlength="50" id="tersier_tebal_kemasan" type="text"  parsley-type="text" placeholder="input tebal kemasan" class="form-control"
              ...
              <div class="callout callout-success" style="border-left-color: #20c997;">
                ...
                <div class="col-sm-12 invoice-col">
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-9 col-sm-10">
                            <input name="bb_nama_bahan_baku" minlength="1" maxlength="50" id="bb_nama_bahan_baku" type="text" parsley-type="text" placeholder="input bb_nama_bahan_baku" class="form-control"
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-9 col-sm-10">
                            <input name="bb_inci_name" minlength="1" maxlength="50" id="bb_inci_name" type="text"  parsley-type="text" placeholder="input nama produk" class="form-control"
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-9 col-sm-10">
                            <input name="bb_manufacture" minlength="1" maxlength="50" id="bb_manufacture" type="text"  parsley-type="text" placeholder="input bb_penyimpanan sediaan" class="form-control"
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-9 col-sm-10">
                            <input name="bb_harga_bahan_baku" minlength="1" maxlength="50" id="bb_harga_bahan_baku" type="text"  parsley-type="text" placeholder="input bb_shelf_life sediaan" class="form-control"
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-9 col-sm-10">
                            <input name="bb_moq" minlength="1" maxlength="50" id="bb_moq" type="text"  parsley-type="text" placeholder="input kemasan primer" class="form-control"
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-9 col-sm-10">
                            <input name="bb_pengunaan" minlength="1" maxlength="50" id="bb_pengunaan" type="text"  parsley-type="text" placeholder="input kemasan sekunder" class="form-control"
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-9 col-sm-10">
                            <input name="bb_lead_time" minlength="1" maxlength="50" id="bb_lead_time" type="text"  parsley-type="text" placeholder="input bb_lead_time" class="form-control"
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-9 col-sm-10">
                            <input name="bb_shelf_life" minlength="1" maxlength="50" id="bb_shelf_life" type="text"  parsley-type="text" placeholder="input sub bb_lead_time" class="form-control"
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-9 col-sm-10">
                            <input name="bb_penyimpanan" minlength="1" maxlength="50" id="bb_penyimpanan" type="text"  parsley-type="text" placeholder="input no formulir" class="form-control"
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-9 col-sm-10">
                            <input name="bk_nama_bahan_kemas" minlength="1" maxlength="50" id="bk_nama_bahan_kemas" type="text"  parsley-type="text" placeholder="input no revisi" class="form-control"
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-9 col-sm-10">
                            <input name="bk_komponen_bahan" minlength="1" maxlength="50" id="bk_komponen_bahan" type="text"  parsley-type="text" placeholder="input tgl berlaku" class="form-control"
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-9 col-sm-10">
                            <input name="bk_manufacture" minlength="1" maxlength="50" id="bk_manufacture" type="text"  parsley-type="text" placeholder="input formula khusus" class="form-control"
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-9 col-sm-10">
                            <input name="bk_harga_bahan_kemas" minlength="1" maxlength="50" id="bk_harga_bahan_kemas" type="text"  parsley-type="text" placeholder="input persamaan produk" class="form-control"
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-9 col-sm-10">
                            <input name="bk_moq" minlength="1" maxlength="50" id="bk_moq" type="text"  parsley-type="text" placeholder="input persamaan produk" class="form-control"
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-9 col-sm-10">
                            <input name="bk_lead_time" minlength="1" maxlength="50" id="bk_lead_time" type="text"  parsley-type="text" placeholder="input persamaan produk" class="form-control"
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-9 col-sm-10">
                            <input name="bk_penyimpanan" minlength="1" maxlength="50" id="bk_penyimpanan" type="text" parsley-type="text" placeholder="input bk_penyimpanan" class="form-control"
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-9 col-sm-10">
                            <input name="target_market" minlength="1" maxlength="50" id="target_market" type="text"  parsley-type="text" placeholder="input nama produk" class="form-control"
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-9 col-sm-10">
                            <input name="estimasi_penjualan" minlength="1" maxlength="50" id="estimasi_penjualan" type="text"  parsley-type="text" placeholder="input bentuk sediaan" class="form-control"
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-9 col-sm-10">
                            <input name="pendaftaran_notifikasi" minlength="1" maxlength="50" id="pendaftaran_notifikasi" type="text"  parsley-type="text" placeholder="input warna sediaan" class="form-control"
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-9 col-sm-10">
                            <input name="rencana_launching_produk" minlength="1" maxlength="50" id="rencana_launching_produk" type="text"  parsley-type="text" placeholder="input kemasan primer" class="form-control"
