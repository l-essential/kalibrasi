      ...
      <div class="row">
        ...
        <form id="formdata" class="form-horizontal" data-parsley-validate="" novalidate="">
            ...
            <div class="form-group row">
                <label for="program" class="col-sm-2 text-right control-label col-form-label">Kode</label><span style="color:red">*</span>
                <div class="col-sm-8">
            ...
            <div class="form-group row">
                <label for="periode" class="col-sm-2 text-right control-label col-form-label">Tahun</label><span style="color:red">*</span>
                <div class="col-sm-6">
            ...
            <div class="form-group row">
                <label for="bln" class="col-sm-2 text-right control-label col-form-label">Bulan</label><span style="color:red">*</span>
                <div class="col-sm-3">
             ...
             <div class="form-group row">
                <label for="lastno" class="col-sm-2 text-right control-label col-form-label">Nomor Terakhir</label><span style="color:red">*</span>
                <div class="col-sm-3">
