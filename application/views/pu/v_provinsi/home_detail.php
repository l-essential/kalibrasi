...
<div class="col-md-12">
    <div class="card card-outline-success">
        <div class="card-header">
            <h4 class="m-b-0 text-white"><i class="fas fa-list-alt"></i>&nbsp;<?php echo 'Data Kota/Kabupaten '; ?>
                ...
                <table id="dataintable" class="table table-bordered color-table muted-table" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center" width="80px">Kode Kota/Kabupaten</th>  
...
<script type="text/javascript">
    ...
    function datakodepos(id) {
        $("#divdetail").load('<?php echo $url_datakodepos; ?>' + '/' + id);
    }
