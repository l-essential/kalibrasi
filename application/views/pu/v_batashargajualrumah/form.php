...
<div class="card card-outline-success">
    ...
    <div class="card card-body">
        <form id="formdata" class="form-horizontal" data-parsley-validate="" novalidate="">
            ...
            <div class="form-group row">
                <label for="harga_perm2" class="col-sm-2 text-right control-label col-form-label">Harge per m2</label><span style="color:red">*</span>
                <div class="col-sm-4">
                    <input name="harga_perm2" id="harga_perm2"  minlength="7" maxlength="11" type="text" required="" parsley-type="text" placeholder="Masukan batas nilai" class="form-control money"
