    ...
    <div class="card card-outline-success">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <button type="button" id="btncreatebunga" class="btn btn-info btn-circle" onclick="adddata_bankquota()"><i class="fa fa-plus"></i> </button>
                <table id="dataintablequota" class="table table-bordered color-table muted-table" width="100%">
                    <thead>
                        <tr>
