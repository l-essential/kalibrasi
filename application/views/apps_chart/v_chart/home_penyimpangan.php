                ...
                <div class="col-md-8">
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="progress-group">
                      ...
                      <div class="progress progress-sm">
                        <div class="progress-bar bg-secondary" style="width: 75%;background-color: #ced4da;"></div>
                      </div>
                    </div>
                    ...
                    <div class="progress-group">
                      ...
                      <span class="float-right"><b>153</b></span>
                      <div class="progress progress-sm">
                        <div class="progress-bar bg-info" style="width: 75%;background-color: #ced4da;"></div>
                      </div>
                    </div>
                    <br>
                  <button type="button" class="btn btn-block btn-outline-secondary btn-xs" onclick="ToController('apps_chart/Chart/Detail_Penyimpangan', '')"> Info Detail </button>
                  </div>
                  <!-- /.col -->
