      ...
      <div class="row">
        ...
        <form id="formdata" class="form-horizontal" data-parsley-validate="" novalidate="">
            ...
            <div class="form-group row">
                <label for="position_code" class="col-sm-2 text-right control-label col-form-label">Department Name <span style="color:red">*</span></label>
                <div class="col-sm-10">
                    <input name="position_code" id="position_code" type="text" required="" parsley-type="text" placeholder="Masukan position_code" class="form-control"
            ...
            <div class="form-group row">
                <label for="position_name" class="col-sm-2 text-right control-label col-form-label">Department Code <span style="color:red">*</span></label>
                <div class="col-sm-10">
                    <input name="position_name" id="position_name" type="text" required="" parsley-type="text" placeholder="Masukan nama penandatangan" class="form-control"
