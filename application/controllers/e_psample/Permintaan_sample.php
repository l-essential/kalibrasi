...
class Permintaan_sample extends MY_Controller {
    ...
    public function getdata() {
        ...
        $checkfield = $param['pic_marketing'];
        $result = $this->modeldata->getby_name('pic_marketing', $checkfield);
        $valid = false;
        $message = "No data";
        if ($result) {
            $valid = true;
     ...
     public function postdata() {
       ...
       public function postdatadetail() {
        ...
        $this->postdatadetail_byparam_with_check($param, $this->prefix_id, 'ukuran_sample');
    }
