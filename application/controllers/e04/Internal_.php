...
class Internal extends MY_Controller {
                 ...
                 $this->load->model('e04/periode_model', 'periode');
                     $this->setmodel($this->pathclass . '/Vendor_model#vendor');
                            $this->load->model('e00/Location_model', 'location');
                                ...
                                $this->load->model('e01/internal_model', 'eks');
    ...
    public function add() {
        ...
        $this->data['default']['readonly_tools_code'] = 'readonly';
    ...
    public function edit($id) {
        ...
        $this->data['default']['startcalibration_date'] = date("d-m-Y", strtotime($row['startcalibration_date']));
            ...
            $this->data["default"]['tools_name'] = $rowtools['tools_name'];
        $this->extenddata();
        parent::edit($id);
    }
    ...
    public function postdatadetail() {
        ...
        if ($param['actiondata'] !== 'delete') {
             $param['periode_start'] = date("Y-m-d", strtotime($param['periode_start']));
             $param['periode_end'] = date("Y-m-d", strtotime($param['periode_end']));
