...
class Vendor extends MY_Controller {
    ...
    public function getdata() {
        ...
        $checkfield = $param['vendor_code'];
        $result = $this->modeldata->getby_name('vendor_code', $checkfield);
        $valid = false;
        $message = "No data";
        if ($result) {
            $valid = true;
     ...
     public function postdata() {
       ...
       public function postdatadetail() {
        ...
        $this->postdatadetail_byparam_with_check($param, $this->prefix_id, 'vendor_detail_name');
    }
