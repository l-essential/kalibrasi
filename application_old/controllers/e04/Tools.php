...
class Tools extends MY_Controller {
    ...
    public function getdata() {
        ...
        $checkfield = $param['tools_noseri_model'];
        $result = $this->modeldata->getby_name('tools_noseri_model', $checkfield);
        $valid = false;
        $message = "No data";
        if ($result) {
            $valid = true;
     ...
     public function postdata() {
       ...
       public function postdatadetail() {
        ...
        $this->postdatadetail_byparam_with_check($param, $this->prefix_id, 'toolsdetail_name');
    }
