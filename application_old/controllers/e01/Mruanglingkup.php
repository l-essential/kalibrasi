<?php
class Mruanglingkup extends MY_Controller {
    ...
    public $noview = 0;
     ...
     function __construct() {
        ...
        $this->controller = $this->pathclass .'/mruanglingkup';
        $this->view = $this->pathclass .'/v_mruanglingkup';
         $this->setmodel($this->pathclass . '/Mruanglingkup_model#mr');//$this->load->model('lessential_pyp/mruanglingkup_model', 'mr');
    }
