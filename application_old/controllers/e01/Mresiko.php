<?php
class Mresiko extends MY_Controller {
    ...
    public $noview = 0;
     ...
     function __construct() {
        ...
        parent::__construct();
        $this->title ="Resiko Penyimpangan";
        $this->controller = 'e01/mresiko';
        $this->view = 'e01/v_mresiko';
        $this->setmodel($this->pathclass . '/mresiko_model#rsk');// $this->load->model('lessential_pyp/mkatagori_model', 'mk');
    }
