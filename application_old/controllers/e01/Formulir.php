...
class formulir extends MY_Controller {
   ...
   public function add() {
        ...
        $resultkatagori = $this->katagori->getAll()->result_array();
        $resultruang = $this->ruang->getAll()->result_array();
        $resultjenis = $this->jenis->getAll()->result_array();
        $resultresiko = $this->resiko->getAll()->result_array();
        $resulttype = $this->tipe->getAll()->result_array();
        $k = 0;
        $r = 0;
        $j = 0;
        $re = 0;
    ...
    //     $row = $this->modeldata->getby_id($id)->row();
    //     $resultkatagori = $this->katagori->getAll()->result_array();;
    //     $resultruang = $this->ruang->getAll()->result_array();;
    //     $resultjenis = $this->jenis->getAll()->result_array();;
    //     $resultresiko = $this->resiko->getAll()->result_array();;
    ...
    //     $this->data['default']['tanggal'] = $row->tanggal;
    //     $this->data['default']['title_improvement'] = $row->title_improvement;
    //     $this->data['default']['number'] = $row->number;
    //     $this->data['default']['rincian_penyimpangan'] = $row->rincian_penyimpangan;
    //     $this->data['default']['rincian_tindakan'] = $row->rincian_tindakan;
    //     $this->data['default']['dampak'] = $row->dampak;
    //     $this->data['default']['uraian'] = $row->uraian;
    ...
    //     $this->data['default']['kesimpulan_akar'] = $row->kesimpulan_akar;
    ...
    //         $this->data['default']['id_katagori'][$k]['value'] = $rowkategori['id_katagori'];
    //         $this->data['default']['id_katagori'][$k]['display'] = $rowkategori['nama_katagori'];
    //         if ($row->id_katagori == $rowkategori['id_katagori']) {
    //             $this->data['default']['id_katagori'][$k]['selected'] = "SELECTED";
    //         }
    //         $k++;
    //     }
    ...
    //         $this->data['default']['id_ruanglingkup'][$r]['value'] = $rowruang['id_ruanglingkup'];
    //         $this->data['default']['id_ruanglingkup'][$r]['display'] = $rowruang['nama_ruanglingkup'];
    //         if ($row->id_ruanglingkup == $rowruang['id_ruanglingkup']) {
    //             $this->data['default']['id_ruanglingkup'][$r]['selected'] = "SELECTED";
    //         }
    //         $r++;
    //     }
    ...
    //         $this->data['default']['id_jenis'][$j]['value'] = $rowjenis['id_jenis'];
    //         $this->data['default']['id_jenis'][$j]['display'] = $rowjenis['nama_jenis'];
    //         if ($row->id_jenis == $rowjenis['id_jenis']) {
    //             $this->data['default']['id_jenis'][$j]['selected'] = "SELECTED";
    //         }
    //         $j++;
    //     }
    ...
    //         $this->data['default']['id_tipe'][$t]['value'] = $rowtype['id_tipe'];
    //         $this->data['default']['id_tipe'][$t]['display'] = $rowtype['nama_tipe'];
    //         if ($row->id_tipe == $rowtype['id_tipe']) {
    //             $this->data['default']['id_tipe'][$t]['selected'] = "SELECTED";
    //         }
    //         $t++;
    //     }
    ...
    //         $this->data['default']['id_resiko'][$re]['value'] = $rowresiko['id_resiko'];
    //         $this->data['default']['id_resiko'][$re]['display'] = $rowresiko['nama_resiko'];
    //         if ($row->id_resiko == $rowresiko['id_resiko']) {
    //             $this->data['default']['id_resiko'][$re]['selected'] = "SELECTED";
    //         }
    //         $re++;
    //     }
