    ...
    <link href="<?php echo $customes ?>DataTables-1.10.11/media/css/fixedColumns.dataTables.min.css" rel="stylesheet">
    <link href="<?php echo $customes ?>DataTables-1.10.11/media/css/jquery.dataTables.min.css" rel="stylesheet">
    ...
    <footer class="main-footer">
        <strong>&copy; 2019-2020 <a target="_blank" href="javascript:;">PT. L`ESSENTIAL</a></strong>
    ...
    <!-- REQUIRED SCRIPTS -->
    <!-- jQuery -->
    <script src="<?php echo $customes ?>DataTables-1.10.11/media/js/jquery-3.5.1.js"></script>
    ...
    <!-- DataTables -->
    <!-- <script src="<?php echo $templates ?>plugins/datatables/jquery.dataTables.min.js"></script>
    <script src="<?php echo $templates ?>plugins/datatables-bs4/js/dataTables.bootstrap4.min.js"></script>
    <script src="<?php echo $templates ?>plugins/datatables-responsive/js/dataTables.responsive.min.js"></script>
    <script src="<?php echo $templates ?>plugins/datatables-responsive/js/responsive.bootstrap4.min.js"></script> -->
    ...
    <script src="<?php echo $customes ?>DataTables-1.10.11/media/js/dataTables.fixedColumns.min.js"></script>
    ...
    <script src="<?php echo $templates ?>socket.io/dist/socket.io.js"></script>
    ...
    <!-- Bootstrap -->
    <script src="<?php echo $templates ?>js-me/time.js"></script>
