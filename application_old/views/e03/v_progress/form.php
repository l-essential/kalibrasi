                ...
                <div class="main-content container-fluid">
                     <div class="form-group">
                        <label for="type" >Kode Katagori</label>
                            <input name="progress_title" id="progress_title" type="text" required="" parsley-type="text" placeholder="Fill progress_title" class="form-control"
                    ...
                    <div class="form-group">
                        ...
                        <input name="progress_persen" id="progress_persen" type="number" required="" parsley-type="text" placeholder="Fill progress_persen" class="form-control"
                                value="<?php echo (isset($default['progress_persen'])) ? $default['progress_persen'] : ''; ?>"
                                <?php echo (isset($default['readonly_progress_persen'])) ? $default['readonly_progress_persen'] : ''; ?>
                                >
                    </div> 
                </div>
