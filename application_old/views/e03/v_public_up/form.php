          ...
          <div class="card">
            ...
            <form id="formdata" data-parsley-validate="" novalidate="">
                ...
                <div class="main-content container-fluid">
                 ...
                 <div class="col-sm-12">
                    <p class="text-right">
                        <button type="submit" id="btnsubmitform" class="btn btn-sm btn-space btn-like"><p class='fa fa-save'>&nbsp;Submit</p></button>
                        <button type="reset" id="btncancelform" class="btn btn-sm btn-space btn-secondary"><p class='fa fa-reply'>&nbsp;Cancel</p></button>
                    </p>
                </div>
            </form>
            </div>
