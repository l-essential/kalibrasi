<!-- Main content -->
      <div class="container-fluid">
        <div class="row">
                  ...
                  <div class="col-md-4">
                    <p class="text-center">
                      <strong>Jumlah Alat 253</strong>
                    </p>
                    <div class="progress-group">
                     Internal
                      <span class="float-right"><b>100</b></span>
                      <div class="progress progress-sm">
                        <div class="progress-bar bg-like" style="width: 80%"></div>
                      </div>
                    </div>
                    <!-- /.progress-group -->
                    <div class="progress-group">
                      Eksternal
                      <span class="float-right"><b>153</b></span>
                      <div class="progress progress-sm">
                        <div class="progress-bar bg-default" style="width: 75%;background-color: #ced4da;"></div>
                      </div>
                    </div>
                     <br>
                    <button type="button" class="btn btn-block btn-outline-secondary btn-xs" onclick="ToController('apps_chart/Chart/Detail_kalibrasi', '')"> Info Detail </button>
                  </div>
                  <!-- /.col -->
              ...
              <div class="card-body">
                ...
                <div class="d-flex flex-row justify-content-end">
                  ...
                  <span>
                   ...
                   <br>
                  <button type="button" class="btn btn-block btn-secondary btn-xs"> Info Detail </button>
                </div>
              </div>
            </div>
            <!-- /.card -->
