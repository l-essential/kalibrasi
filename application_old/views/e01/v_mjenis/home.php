...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#dataintable").dataTable({
            ...
            "columns": [
                {
                    "data": "id_jenis", "width": "75px", "sClass": "text-center",
                    "bSortable": false,
                    "mRender": function (data, type, row) {
                        var btn = "";
                        btn = btn + "<td><a href='#' onClick='editdata(" + row.id_jenis + ")' class='text-muted'><i class='far fa-edit'></i></a></td>";
                        btn = btn + "&nbsp;&ensp;";
                        btn = btn + "<td><a href='#' onClick='deletedata(" + row.id_jenis + ")' class='text-muted'><i class='far fa-trash-alt'></i></a></td>";
                        return btn;
                    }
                },
                {"data": "kode_jenis"},
