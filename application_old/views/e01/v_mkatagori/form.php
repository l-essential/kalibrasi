        ...
        <form id="formdata" data-parsley-validate="" novalidate="">
            ...
            <input type="hidden" name="<?php echo $prefix_id ?>" id="id" value="<?php echo $id; ?>" />
             <input type="hidden" name="actiondata" id="actiondata" />
                ...
                <input type="hidden" name="checkdata1" id="checkdata1" value="kode_katagori" />
            ...
            <div class="form-group row">
              <label for="type" >Kode Katagori</label>
                <input name="kode_katagori" id="kode_katagori" type="text" required="" parsley-type="text" placeholder="Fill kode_katagori" class="form-control"
                        value="<?php echo (isset($default['kode_katagori'])) ? $default['kode_katagori'] : ''; ?>"
                        <?php echo (isset($default['readonly_kode_katagori'])) ? $default['readonly_kode_katagori'] : ''; ?>
                        >
            </div>
            <div class="form-group row">
                <label for="type" >Nama Katagori</label>
                  <input name="nama_katagori" id="nama_katagori" type="text" required="" parsley-type="text" placeholder="Fill nama_katagori" class="form-control"
                          value="<?php echo (isset($default['nama_katagori'])) ? $default['nama_katagori'] : ''; ?>"
                          <?php echo (isset($default['readonly_nama_katagori'])) ? $default['readonly_nama_katagori'] : ''; ?>
                          >
            </div>
