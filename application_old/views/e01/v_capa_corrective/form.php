        ...
        <div class="col-12">
          <div class="card">
            ...
            <form id="formdata" data-parsley-validate="" novalidate="">
                ...
                <input type="hidden" name="checkdata1" id="checkdata1" value="correct_act" />
                ...
                <div class="main-content container-fluid">
                    <div class="form-group" style="padding-left: 9px;">
                        ...
                        <textarea name="correct_act" id="correct_act" class="form-control" rows="2" placeholder="CORRECTIVE ACTION ..."></textarea>
                        </div>                        
                    </div>
                    <div class="form-group" style="padding-left: 9px;" autocomplete="off">
                        <div class="col-sm-12" style="padding-left: 0px;">
                            <input type ="text" name="correct_duedate" id="correct_duedate" class="form-control" placeholder="Due Date ..."/>
                        </div>                        
                    </div>
                    <div class="form-group row" style="padding-left: 9px;">
                        <div class="col-sm-12" style="padding-left: 0px;">
                        <div class="form-group row" style="padding-left: 25px;">
                            <input type="radio" id="correct_status" name="correct_status" value="CLOSED">&ensp;
                            <label for="CLOSED">CLOSED</label>&emsp;&emsp; 
                            <input type="radio" id="correct_status" name="correct_status" value="OPEN">&ensp;
                    ...
                    <div class="form-group" style="padding-left: 9px;" autocomplete="off">
                        <div class="col-sm-12" style="padding-left: 0px;">
                        <select id="correct_pic" name="correct_pic[]" multiple class="form-control form-control-sm chosen-select" required="">
...
<script type="text/javascript">
    ...
    $("#correct_pic").chosen({max_selected_options: 25});
</script>
