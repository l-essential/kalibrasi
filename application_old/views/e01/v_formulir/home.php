  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Data Penyimpangan dibuat Saya</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header border-transparent">
                 <h3 class="card-title">
                 <div class="btn-group">
                        <button type="button" class="btn btn-info">Data Penyimpangan Dibuat oleh saya</button>
                        ...
                        <button type="button" class="btn btn-default" onclick="ToController('e01/approve')">Penyimpangan yang berkaitan dengan Department saya</button>
                      </div>
                 </h3>
            ...
            "columns": [
                {
                  ...
                  "mRender": function (data, type, row) {
                      ...
                      if (accessedit == true) {
                        btn = btn + "<a href='javascript:void(0)' onClick='editdata(" + idtr + ")' class='text-inverse' data-toggle='tooltip' title='Input capa' data-original-title='Input capa'><i class='fas fa-edit'></i></a>&nbsp;&nbsp;";
                      }
