 ...
 <section class="content">
      <div class="row">
        ...
        <form id="formdata" class="form-horizontal" data-parsley-validate="" novalidate="">
            ...
            <div class="form-group row">
                <label for="oldpassword" class="col-sm-2 control-label col-form-label">Old Password <span style="color:red">*</span></label>
                <div class="col-sm-10">
            ...
            <div class="form-group row">
                <label for="newpassword" class="col-sm-2 control-label col-form-label">New Password <span style="color:red">*</span></label>
                <div class="col-sm-10">
                    <input name="newpassword" id="newpassword" type="text" minlength="5" maxlength="8" required="" parsley-type="text" placeholder="Fill new password" class="form-control"
            ...
            <div class="col-12">
              <p class="text-right">
                <button type="submit" class="btn btn-sm btn-secondary" onclick="ToController('scr/Useraccess/home_info', '')"><li class='fas fa-times'></li> Back to Profile</button>
                <button type="submit" id="btnsubmitform" class="btn btn-sm btn-like"><li class='fas fa-check'></li> Change Password</button>
              </p>
              </div>
    </div>
</form>
