        ...
        <form id="formdata" data-parsley-validate="" novalidate="" autocomplete="off">
            ...
            <div class="form-group row">
                <label class="col-sm-3 col-form-label" autocomplete="off">Tanggal Awal Kalibrasi <span style="color:red">*</span></label>
                  <div class="col-sm-9">
                      <input name="startcalibration_date" minlength="1" maxlength="30" id="startcalibration_date" type="text" required=""  parsley-type="text" placeholder="input pembelian alat" class="form-control"
