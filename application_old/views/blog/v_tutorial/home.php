...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#dataintable").dataTable({
            ...
            "columns": [
                {
                    "data": "info_tutorial_id", "width": "75px", "sClass": "text-center",
                    "bSortable": false,
                    "mRender": function (data, type, row) {
                        var btn = "";

                       if (accessedit == true) {
                            btn = btn + "<a href='javascript:void(0)' onClick='editdata(" + row.info_tutorial_id + ")' class='text-inverse' title='' data-toggle='tooltip' data-original-title='Edit'><i class='fas fa-edit'></i></a> &nbsp;";
                        }
                        if (accessdelete == true) {
                            btn = btn + "<a href='javascript:void(0)' onClick='deletedata(" + row.info_tutorial_id + ")' class='text-inverse' title='' data-toggle='tooltip' data-original-title='Delete'><i class='far fa-trash-alt'></i></a>";
                        }
                        return btn;
                    }
                },
                {"data": "info_tutorial_title"},
                {"data": "info_tutorial_note"},
