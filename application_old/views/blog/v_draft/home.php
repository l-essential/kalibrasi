...
<script type="text/javascript">
    url_setstatuslist = '<?php echo $url_setstatuslist; ?>';
            ...
            "columns": [
                            {
                                ...
                                "mRender": function (data, type, row) {
                                    var btn = "";
                                    if (accessedit == true) {
                                        btn = btn + "<a href='javascript:void(0)' onClick='editdata(" + row.id_article + ")' class='text-inverse' title='' data-toggle='tooltip' data-original-title='Edit'><i class='fas fa-edit'></i></a> &nbsp;";
                                    }
                                    return btn;
                                }
                            },
