...
(8, '2015-03-17', 2015, 3, '0.0750', 16, 15, 31, '0.0750', '0.1250', 'active', 1, '2019-09-25 22:17:42', 1, '2019-09-25 22:17:54', NULL, NULL),
(9, '2015-04-14', 2015, 4, '0.0750', 13, 17, 30, '0.0750', '0.1250', 'active', 1, '2019-09-25 22:18:29', 1, '2019-09-25 22:18:44', NULL, NULL);
...
CREATE TABLE `t_pengajuanbankheader` (
  ...
  `penagihanke` int(3) NOT NULL DEFAULT '0',
  ...
  `lampiran_form1` varchar(255) DEFAULT NULL,
  `lampiran_lainnya` varchar(255) NOT NULL,
  `nama_lampiran_spv` varchar(255) DEFAULT NULL,
  `nama_lampiran_drkas` varchar(255) DEFAULT NULL,
  `nama_lampiran_form1` varchar(255) DEFAULT NULL,
  `nama_lampiran_lainnya` varchar(255) DEFAULT NULL,
...
--
-- Dumping data for table `t_pengajuanbankheader`
--

INSERT INTO `t_pengajuanbankheader` (`id_t_pengajuanbankheader`, `no_sk`, `tanggal_surat`, `daritanggal`, `sampaitanggal`, `id_bankquotatahunan`, `prihal`, `penagihanke`, `jenisperhitungan`, `cek_dukcapil`, `lampiran_spv`, `lampiran_drkas`, `lampiran_form1`, `lampiran_lainnya`, `nama_lampiran_spv`, `nama_lampiran_drkas`, `nama_lampiran_form1`, `nama_lampiran_lainnya`, `statuspengajuan`, `statusdata`, `createby`, `createtime`, `updateby`, `updatetime`, `deleteby`, `deletetime`) VALUES
(2, 'SK/201/NOC-KPR.FLPP/VII/2019', '2019-09-05', '2019-04-15', '2019-06-26', 1, 'Permintaan pembayaran subsidi bantuan uang muka perumahan bulan februari sampai dengan juni 2019', 12, 1, 1, 'public/uploads/pu/pengajuanbank/5663d9f259f0bf1cf07f913de74f1e67.jpg', 'public/uploads/pu/pengajuanbank/bda3099cc0a28c48b1a315fa05defe26.jpg', 'public/uploads/pu/pengajuanbank/9a4c157d8354b915a535cc892c3794c9.xlsx', 'public/uploads/pu/pengajuanbank/82ba24f5eb89e56f989188fed040f957.pdf', '5663d9f259f0bf1cf07f913de74f1e67.jpg', 'bda3099cc0a28c48b1a315fa05defe26.jpg', '9a4c157d8354b915a535cc892c3794c9.xlsx', '82ba24f5eb89e56f989188fed040f957.pdf', 1, 'active', 1, '2019-09-26 00:28:58', 1, '2019-09-26 00:28:58', NULL, NULL);
...
--
ALTER TABLE `m_sukubungabirate`
  MODIFY `id_m_sukubungabirate` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `t_pengajuanbankheader`
  MODIFY `id_t_pengajuanbankheader` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
